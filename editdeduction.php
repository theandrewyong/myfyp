...
if(isset($_POST["submit"])){
    ...
    if(empty($edited_deduction_display_id)){
        $error_deduction_id = '<span class="text-danger"> *Invalid Deduction ID</span>';
        $error = TRUE;
    }

    if(empty($edited_deduction_desc)){
       $error_deduction_desc = '<span class="text-danger"> *Invalid Deduction Description</span>';
       $error = TRUE; 
    }

    if(empty($edited_deduction_rate)){
        $error_deduction_rate = '<span class="text-danger"> *Invalid Deduction Rate</span>';
        $error = TRUE;
    }
