...
while($data=@mysqli_fetch_array($query)) {
	...
	$format_socso_employee_deduction_total = number_format("$socso_employee_deduction_total",2);
	$pdf->Cell (10,7,$data["emp_id"],0,0);
	$pdf->Cell (150,7,$data["emp_full_name"],0,0);
	$pdf->Cell (30,7,$socso_employee_wages,0,0,"R");
	$pdf->Cell (30,7,$socso_employee_deduction,0,0,"R");
	$pdf->Cell (30,7,$socso_employer_deduction,0,0,"R");
	$pdf->Cell (30,7,$format_socso_employee_deduction_total,0,1,"R");
	$count = $count+1;
