<?php
	...
	if(isset($_POST["submit"])){
		...
		while($ef = mysqli_fetch_assoc($epf_formula_sql)){
			...
			//Check wage and compare to Wage Start and Wage End in epf_formula table
	...
	//Get data from process_payroll and employee_info tables
