<?php
	...
	//Select data from process_payroll table for process payroll history
	...
	//Select data from process_adhoc table for process adhoc history
									...
									if($data_exists){
										foreach($unique_month_array as $uma){
											foreach($unique_year_array as $uya){
												//Select data from process_payroll table
									...
									<?php
										foreach($adhoc_unique_month_array as $auma){
											foreach($adhoc_unique_year_array as $auya){
												//Select data from process_adhoc table
