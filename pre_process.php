...
$employee_wages = $get_w_a_result["emp_wages"];
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-6 text-danger">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="epf" onchange="countNetPay()" name="new_epf" value="<?php echo number_format(0.00,2); ?>">
                                </div>
                            </div>               
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-6 text-primary">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="overtime" onchange="countNetPay()" name="new_overtime" value="<?php echo number_format(0.00,2); ?>">
                                </div>
                            </div>
                            <div class="col-md-6 col-6 text-danger">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-6 text-primary">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="commission" onchange="countNetPay()" name="new_commission" value="<?php echo number_format(0.00,2); ?>">
                                </div>
                            </div>
                            <div class="col-md-6 col-6 text-danger">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-6 text-danger">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="deduction" onchange="countNetPay()" name="new_additional_deduction" value="<?php echo number_format(0.00,2); ?>">
                                </div>
                            </div>               
                        </div> 
                        <div class="row">
                            <div class="col-md-6 col-6 text-primary">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="claims" onchange="countNetPay()" name="new_claims" value="<?php echo number_format(0.00,2); ?>">
                                </div>
                            </div>
                            <div class="col-md-6 col-6 text-danger">
                                <div class="form-group">
                                    <label for="new_loan"><h5 class="pt-2">Loan:</h5></label>
                                    <input type="text" class="form-control" id="loan" onchange="countNetPay()" name="new_loan" value="<?php echo number_format(0.00,2); ?>">
                                </div>
                            </div>               
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-6 text-primary">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="director_fees" onchange="countNetPay()" name="new_director_fees" value="<?php echo number_format(0.00,2); ?>">
                                </div>
                            </div>
                            <div class="col-md-6 col-6 text-danger">
                                <div class="form-group">
                                    <label for="new_unpaid_leave"><h5 class="pt-2">Unpaid Leave:</h5></label>
                                    <input type="text" class="form-control" id="unpaid_leave" onchange="countNetPay()" name="new_unpaid_leave" value="<?php echo number_format(0.00,2); ?>">
                                </div>
                            </div>               
                        </div> 
                        <div class="row">
                            <div class="col-md-6 col-6 text-primary">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="advance_paid" onchange="countNetPay()" name="new_advance_paid" value="<?php echo number_format(0.00,2); ?>">
                                </div>
                            </div>
                            <div class="col-md-6 col-6 text-danger">
                                <div class="form-group">
                                    <label for="new_advance_deduct"><h5 class="pt-2">Advance Deduct:</h5></label>
                                    <input type="text" class="form-control" id="advance_deduct" onchange="countNetPay()" name="new_advance_deduct" value="<?php echo number_format(0.00,2); ?>">
                                </div>
                            </div>               
                        </div> 
                        <div class="row">
                            <div class="col-md-6 col-6 text-primary">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="bonus" onchange="countNetPay()" name="new_bonus" value="<?php echo number_format(0.00,2); ?>">
                                </div>
                            </div>              
                        </div>
                    <div class="row">
                        <div class="col-md-6 col-6 text-primary">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="others" onchange="countNetPay()" name="new_others" value="<?php echo number_format(0.00,2); ?>">
                            </div>
                        </div>              
                    </div>                
                    </div>
